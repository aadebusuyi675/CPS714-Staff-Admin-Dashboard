...
export default function ViewHome() {
    return (
        <div>
            <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&icon_names=assignment,exercise,id_card,person_apron,quiz" />
            ...
            <br/><br/>
            <button className="button"> <span className="material-symbols-outlined icon-setting">assignment</span> <Link to={"/reports"}>View Reports</Link> </button>
            </div>
        </div>
    )
}
